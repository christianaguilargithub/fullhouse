      ...
      <div class="antialiased bg-gray-300">
          <div class="flex w-full min-h-screen justify-center items-center p-3">
              <div class="flex flex-col space-y-4 bg-gray-400 w-full max-w-4xl rounded-xl shadow-lg text-white">
                <h1 class="font-bold text-4xl tracking-wide p-2 text-gray-700">Contact Us</h1>
                  <form class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" onSubmit={handleSubmit(onSubmit)}>
